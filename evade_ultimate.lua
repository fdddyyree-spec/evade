...
-- VERSION 2.0 - Sky Revive Edition
print("🎮 Загрузка Evade Ultimate v2.0...")
...
Title.Text = "Evade Ultimate - Sky Revive"
...
print("✅ Evade Ultimate v2.0 загружен!")
print("📋 Right Shift = открыть GUI")
print("💚 Нажмите 🚀 START AFK (FLY MODE) для парения")
print("")
print("🔄 Если видите старую версию GUI - перезапустите скрипт!")

game:GetService("StarterGui"):SetCore("SendNotification", {
    Title = "Evade Ultimate v2.0";
