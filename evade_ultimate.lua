...
local function CreateButton(text, callback)
    ...
    Button.MouseButton1Click:Connect(function()
        ...
        TweenService:Create(Button, tweenInfo, {BackgroundColor3 = Color3.fromRGB(50, 50, 55)}):Play()
        wait(0.1)
        TweenService:Create(Button, tweenInfo, {BackgroundColor3 = Color3.fromRGB(40, 40, 45)}):Play()
        callback()
    end)
...
local function CreateToggle(text, setting, callback)
    ...
    local toggled = Settings[setting] or false
    ...
    ToggleButton.MouseButton1Click:Connect(function()
        toggled = not toggled
        Settings[setting] = toggled
        
        local tweenInfo = TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
        
        if toggled then
            TweenService:Create(ToggleButton, tweenInfo, {BackgroundColor3 = Color3.fromRGB(100, 200, 100)}):Play()
            TweenService:Create(ToggleCircle, tweenInfo, {Position = UDim2.new(1, -18, 0.5, -8)}):Play()
        else
            TweenService:Create(ToggleButton, tweenInfo, {BackgroundColor3 = Color3.fromRGB(60, 60, 65)}):Play()
...
-- Toggles
CreateToggle("⚡ Speed Boost", "Speed", function(state)
    if not state then
        local hum = GetHum()
        if hum then hum.WalkSpeed = 16 end
    end
...
CreateToggle("🦘 Jump Boost", "Jump", function(state)
    if not state then
        local hum = GetHum()
        if hum then
            if hum.UseJumpPower then
...
CreateToggle("🔨 Prank Stick", "PrankStick")
...
CreateButton("💚 Revive All Players", function()
    ReviveAllPlayers()
end)
...
CreateButton("🚪 Break All Doors", function()
    local count = BreakAllDoors()
    game:GetService("StarterGui"):SetCore("SendNotification", {
        Title = "Doors";
        Text = "Сломано: " .. count;
...
print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
print("🎮 GUI загружен!")
print("📋 Нажмите Right Shift чтобы открыть/закрыть GUI")
print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")

game:GetService("StarterGui"):SetCore("SendNotification", {
    Title = "Evade Ultimate";
    Text = "GUI загружен! Нажмите Right Shift";
    Duration = 5;
})
